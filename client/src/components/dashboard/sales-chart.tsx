  ...
  datasets: [
    {
      ...
      borderColor: "rgb(202, 42, 42)",
      backgroundColor: "rgba(202, 42, 42, 0.12)",
      tension: 0.4,
    },
    {
      label: "Orders",
...
export function SalesChart() {
  return (
    <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-3 sm:p-6 border border-gray-200 dark:border-[#1F1F23] border-t-4 border-t-[#1DA1F2] w-full min-w-0">
...
export function RevenueChart() {
  return (
    <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-3 sm:p-6 border border-gray-200 dark:border-[#1F1F23] border-t-4 border-t-[#FF0000] w-full min-w-0">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-2">
