...
const statusColors = {
  ...
  cancelled: "bg-[#1DA1F2]/10 text-[#1DA1F2] dark:bg-[#1DA1F2]/20 dark:text-[#FF0000]",
}
  ...
  return (
    <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-6 border border-gray-200 dark:border-[#1F1F23] border-t-4 border-t-[#1DA1F2]">
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="text-sm text-[#1DA1F2] hover:text-[#FF0000] font-medium hover:underline">View all</button>
      </div>
