...
import { loginUser, clearError, ROLE_DISPLAY_NAMES, type UserRole } from "@/store/slices/authSlice"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (loginUser.fulfilled.match(result)) {
      ...
      dispatch(showSuccessToast(
        'Login Successful',
        `Welcome back, ${user.fullName}! Logged in as ${roleName}.`
      ))
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="flex items-center mb-8">
            <div className="w-12 h-12 bg-[#1DA1F2/80] rounded-lg flex items-center justify-center mr-4">
              {/* <span className="text-white font-bold text-xl">R</span> */}
              <img src={logo}/>
            </div>
            <span className="text-2xl font-bold">Smritisudha Admin</span>
          </div>
          ...
          <div className="space-y-6 mb-12">
            ...
            <div className="flex items-center">
              <div className="w-8 h-8 bg-[#1DA1F2]/20 rounded-full flex items-center justify-center mr-4">
          ...
          {/* Testimonial */}
          <blockquote className="border-l-4 border-[#1DA1F2] pl-6">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center justify-center mb-8">
            <div className="w-12 h-12 bg-[#1DA1F2] rounded-lg flex items-center justify-center mr-3">
              <span className="text-white font-bold text-xl">R</span>
            </div>
            <span className="text-2xl font-bold text-slate-900">Smritisudha Admin</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/auth/forgot" className="text-sm text-slate-900 hover:text-slate-700 font-medium">
                Forgot password?
              </Link>
            </div>
