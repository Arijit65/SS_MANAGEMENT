export function AuthBrandSection() {
  ...
  return (
    <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#1a0000] via-[#2d0000] to-[#1a0000] relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#1DA1F2]/20 to-[#FF0000]/10" />
      ...
      <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white">
        <div className="mb-8">
          <div className="flex items-center mb-6">
            ...
            />
            <h1 className="text-2xl font-bold">Smritisudha Admin</h1>
          </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4">
            <div className="w-8 h-8 bg-[#1DA1F2] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
        ...
        <div className="mt-12 pt-8 border-t border-slate-700">
          <p className="text-slate-400 text-sm">
            "Smritisudha Admin has transformed how we manage our content. The intuitive interface and powerful features make
            it a joy to use."
          </p>
