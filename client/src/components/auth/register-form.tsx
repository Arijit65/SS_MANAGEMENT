...
export function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await dispatch(registerUser({ fullName, email: formData.email, password: formData.password }))
        ...
        <div className="w-full max-w-md">
          <div className="space-y-6">
            ...
            <div className="lg:hidden flex items-center justify-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-slate-900">Smritisudha Admin</h1>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm text-slate-600">
                ...
                <Link to="/auth/login" className="text-slate-900 hover:text-slate-700 font-medium">
                  Sign in
                </Link>
              </p>
            </div>
