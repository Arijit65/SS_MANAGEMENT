...
const categoryColors = {
  ...
  Health: "bg-[#1DA1F2]/10 text-[#1DA1F2] dark:bg-[#1DA1F2]/20 dark:text-[#FF0000]",
}
    ...
    <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-6 border border-gray-200 dark:border-[#1F1F23] border-t-4 border-t-[#1DA1F2]">
      ...
      <div className="space-y-3">
        {posts.map((post) => (
          <div
            key={post.id}
            className={`flex items-center justify-between p-3 rounded-lg border transition-colors hover:bg-[#1DA1F2]/5 ${
              post.featured ? "border-[#1DA1F2]/30 bg-[#1DA1F2]/5" : "border-border"
            }`}
          >
